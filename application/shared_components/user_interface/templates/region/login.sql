...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497653172643261486)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497653472011261486)
,p_plug_template_id=>wwv_flow_imp.id(102497653172643261486)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497653794199261486)
,p_plug_template_id=>wwv_flow_imp.id(102497653172643261486)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497654057386261486)
,p_plug_template_id=>wwv_flow_imp.id(102497653172643261486)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497654317477261486)
,p_plug_template_id=>wwv_flow_imp.id(102497653172643261486)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497654614089261486)
,p_plug_template_id=>wwv_flow_imp.id(102497653172643261486)
,p_name=>'Sub Regions'
