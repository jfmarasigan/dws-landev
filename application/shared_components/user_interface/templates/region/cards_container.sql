...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102496798865958261465)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496799145644261465)
,p_plug_template_id=>wwv_flow_imp.id(102496798865958261465)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496799480972261465)
,p_plug_template_id=>wwv_flow_imp.id(102496798865958261465)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496799703575261465)
,p_plug_template_id=>wwv_flow_imp.id(102496798865958261465)
,p_name=>'Sub Regions'
