...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102496791711684261462)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496792045783261462)
,p_plug_template_id=>wwv_flow_imp.id(102496791711684261462)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496792320280261462)
,p_plug_template_id=>wwv_flow_imp.id(102496791711684261462)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496792646380261462)
,p_plug_template_id=>wwv_flow_imp.id(102496791711684261462)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496792935225261462)
,p_plug_template_id=>wwv_flow_imp.id(102496791711684261462)
,p_name=>'Sub Regions'
