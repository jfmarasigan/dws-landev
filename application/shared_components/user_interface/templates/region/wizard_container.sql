...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497675828249261494)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497676124403261494)
,p_plug_template_id=>wwv_flow_imp.id(102497675828249261494)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497676474096261494)
,p_plug_template_id=>wwv_flow_imp.id(102497675828249261494)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497676776527261494)
,p_plug_template_id=>wwv_flow_imp.id(102497675828249261494)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497677093716261494)
,p_plug_template_id=>wwv_flow_imp.id(102497675828249261494)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497677313768261494)
,p_plug_template_id=>wwv_flow_imp.id(102497675828249261494)
