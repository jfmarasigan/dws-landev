...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497620482553261473)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497620785229261473)
,p_plug_template_id=>wwv_flow_imp.id(102497620482553261473)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497621086211261474)
,p_plug_template_id=>wwv_flow_imp.id(102497620482553261473)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497621342027261474)
,p_plug_template_id=>wwv_flow_imp.id(102497620482553261473)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497621632244261474)
,p_plug_template_id=>wwv_flow_imp.id(102497620482553261473)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497621922771261474)
,p_plug_template_id=>wwv_flow_imp.id(102497620482553261473)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497622268362261474)
,p_plug_template_id=>wwv_flow_imp.id(102497620482553261473)
,p_name=>'Sub Regions'
