...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497655651343261487)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497655931255261487)
,p_plug_template_id=>wwv_flow_imp.id(102497655651343261487)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497656221784261487)
,p_plug_template_id=>wwv_flow_imp.id(102497655651343261487)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497656596165261487)
,p_plug_template_id=>wwv_flow_imp.id(102497655651343261487)
,p_name=>'Sub Regions'
