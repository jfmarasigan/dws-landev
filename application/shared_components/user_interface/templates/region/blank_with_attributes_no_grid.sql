...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102496793181165261462)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496793448682261463)
,p_plug_template_id=>wwv_flow_imp.id(102496793181165261462)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496793702373261463)
,p_plug_template_id=>wwv_flow_imp.id(102496793181165261462)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496794016668261463)
,p_plug_template_id=>wwv_flow_imp.id(102496793181165261462)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496794394837261463)
,p_plug_template_id=>wwv_flow_imp.id(102496793181165261462)
,p_name=>'Sub Regions'
