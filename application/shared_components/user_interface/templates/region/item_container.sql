...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497650600545261485)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497650920746261485)
,p_plug_template_id=>wwv_flow_imp.id(102497650600545261485)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497651205159261485)
,p_plug_template_id=>wwv_flow_imp.id(102497650600545261485)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497651593620261485)
,p_plug_template_id=>wwv_flow_imp.id(102497650600545261485)
,p_name=>'Button Start'
