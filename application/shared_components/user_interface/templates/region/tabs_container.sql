...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497668164585261491)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497668400604261491)
,p_plug_template_id=>wwv_flow_imp.id(102497668164585261491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497668750715261491)
,p_plug_template_id=>wwv_flow_imp.id(102497668164585261491)
,p_name=>'Tabs'
