...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497648570905261484)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497648811877261484)
,p_plug_template_id=>wwv_flow_imp.id(102497648570905261484)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497649127755261484)
,p_plug_template_id=>wwv_flow_imp.id(102497648570905261484)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497649447890261484)
,p_plug_template_id=>wwv_flow_imp.id(102497648570905261484)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497649728484261485)
,p_plug_template_id=>wwv_flow_imp.id(102497648570905261484)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497650019202261485)
,p_plug_template_id=>wwv_flow_imp.id(102497648570905261484)
,p_name=>'Sub Regions'
