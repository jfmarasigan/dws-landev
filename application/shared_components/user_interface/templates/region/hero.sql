...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497625050067261475)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497625351706261475)
,p_plug_template_id=>wwv_flow_imp.id(102497625050067261475)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497625686880261475)
,p_plug_template_id=>wwv_flow_imp.id(102497625050067261475)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497625937855261475)
,p_plug_template_id=>wwv_flow_imp.id(102497625050067261475)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497626219414261476)
,p_plug_template_id=>wwv_flow_imp.id(102497625050067261475)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497626593930261476)
,p_plug_template_id=>wwv_flow_imp.id(102497625050067261475)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
