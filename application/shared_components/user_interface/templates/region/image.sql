...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(102497628563913261477)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497628833833261477)
,p_plug_template_id=>wwv_flow_imp.id(102497628563913261477)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102497629156489261477)
,p_plug_template_id=>wwv_flow_imp.id(102497628563913261477)
,p_name=>'Sub Regions'
