...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(102496785081926261459)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496785352733261459)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496785642116261459)
,p_page_template_id=>wwv_flow_imp.id(102496785081926261459)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496785992892261459)
,p_page_template_id=>wwv_flow_imp.id(102496785081926261459)
