...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(102496776480946261455)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496776715926261456)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496777030705261456)
,p_page_template_id=>wwv_flow_imp.id(102496776480946261455)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496777390475261456)
,p_page_template_id=>wwv_flow_imp.id(102496776480946261455)
