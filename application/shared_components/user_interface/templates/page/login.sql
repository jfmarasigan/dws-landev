...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(102496765963792261451)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496766572417261451)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496766927376261452)
,p_page_template_id=>wwv_flow_imp.id(102496765963792261451)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496767252385261452)
,p_page_template_id=>wwv_flow_imp.id(102496765963792261451)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(102496767540175261452)
,p_page_template_id=>wwv_flow_imp.id(102496765963792261451)
,p_name=>'Body Footer'
